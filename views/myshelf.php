...
<html>
	<head>
		...
		<link rel="stylesheet" href="<?=base_url()?>assets/css/shelfstyle.css">
		<link rel="stylesheet" href="<?=base_url()?>assets/css/docstyle.css">
		<link rel="shortcut icon" href="<?=base_url()?>assets/images/Logo.png">
		<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
		<title>Shelf | My Shelves</title>
	</head>
	...
	<body>
		<div class="container">
			...
			<div id="navId" class="topnav">
				...
				<a href="<?=base_url()?>index.php/shelves" class="active">My Shelves</a>
	...
	<script>
		...
		xhttp.onreadystatechange = function() {
			if (this.readyState == 4 && this.status == 200) {
			   	document.getElementById("shelves").innerHTML = this.responseText;
			}
		};
		xhttp.open("GET", "/Shelf/index.php/shelves/retrieveShelves", true);
		xhttp.send();	
	</script>
